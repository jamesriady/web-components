...
module.exports = (env) => {
    ...
    return {
        entry: {
            ...
            'components/vue-app': root('src/components/vue-app/main.js'),
        },
        output: {
            path: root('dist'),
        ...
        plugins: [
            ...
            new HtmlWebpackPlugin({
                chunks: ['components/vue-app'],
                filename: 'components/vue-app.html',
                template: root('src/components/vue-app/index.html'),
                inject: false,
            }),
        ]
    };
